...
<head>
    ...
    <style>
        * {
        ...
        width: 100%;
        height: 95vh;
        background: url({{ asset('images/slider2/712.png') }}) center/cover no-repeat;
...
<body>
    ...
    <section class="slider">
        ...
        <h1 class="animated-text">Packaging</h1>
    ...
    <div class="container">
        ...
        <h3 class="subtitle">What is Packaging?</h3>

        <p class="description">
        Packaging is Packaging means designing, engineering and building the container or wrapping for a product. Primarily it
        acts two purposes: protecting the product and selling it. Carefully considered package design can affect everything from
        delivery damage to get customer attraction and retailer motivation to stock your product
        </p>

        <h3 class="subtitle">Why Need Packaging in Your Marketing?</h3>

        <p class="bold-text">1. Packaging is a powerful mode of communication.</p>
        <p class="description">
        ...
        <p class="description">
            ...
            down geographical barriers, appealing to a multilingual audience is important. Packaging is one of the best ways to achieve it.
        </p>

        <p class="highlight-text">
            You don’t get a second chance at a first impression, so your business’Packaging needs to be spot on right away. Our creative designers offer outstanding and attention-grabbing visuals for brochures, banners, flyers, business cards and many more. We will
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="work-card" data-category="design" onclick="openProject('1', 'Design')">
                        <img src="{{ asset('images/work/1.jpg') }}" alt="Packaging">
                        <div class="work-info">Packaging</div>
                        <div class="category-name">Design</div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="work-card" data-category="development" onclick="openProject('2', 'Development')">
                        <img src="{{ asset('images/work/2.jpg') }}" alt="Packaging">
                        <div class="work-info">Packaging</div>
                ...
                <div class="col-md-3">
                    <div class="work-card" data-category="photography" onclick="openProject('3', 'Photography')">
                        <img src="{{ asset('images/work/3.jpg') }}" alt="Packaging">
                        <div class="work-info">Packaging</div>
                ...
                <div class="col-md-3">
                    <div class="work-card" data-category="design" onclick="openProject('4', 'Design')">
                        <img src="{{ asset('images/work/4.jpg') }}" alt="Packaging">
                        <div class="work-info">Packaging</div>
                        <div class="category-name">Design</div>
                    </div>
                </div>
