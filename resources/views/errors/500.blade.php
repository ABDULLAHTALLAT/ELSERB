...
<svg id="500_Bill" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
    ...
    <g id="smokes" fill="#D5DADB">
        ...
        <circle id="smoke-base-1" class="smoke" style="animation-delay: -0.2s; -moz-transform-origin:464.3px 78.4px;"
            cx="464.3" cy="78.4" r="11.3" />
        <circle id="smoke-base-3" class="smoke" style="animation-delay: -0.1s; -moz-transform-origin:492.9px 83.8px;"
            cx="492.9" cy="83.8" r="8.6" />
        <circle id="smoke-base-2" style="-moz-transform-origin:480px 70.4px;" class="smoke" cx="480" cy="70.4" r="8" />
        <circle id="smoke-float-2" style="-moz-transform-origin:464.9px 53.3px;" class="emitted-ember" fill-opacity=".8"
            cx="464.9" cy="53.3" r="5.4" />
        ...
        <circle id="smoke-float-5" style="-moz-transform-origin:470.4px 28.2;" class="emitted-ember" fill-opacity=".3"
            cx="470.4" cy="28.2" r="2.5" />
    ...
    <g id="fire" clip-path="url(#flame-mask)">
        ...
        <path id="flame-inner-right" style="-moz-transform-origin: 476.268px 97px;" class="flame-inner" fill="#FFD657"
...
<div style="text-align: center; margin-top: 20px;">
    <a href="{{ route('home') }}"
        style="background-color: #263D52; color: white; padding: 10px 20px; font-size: 16px; border: none; border-radius: 5px; cursor: pointer; text-decoration: none; display: inline-block;">
        Go to Home
    </a>
</div>
